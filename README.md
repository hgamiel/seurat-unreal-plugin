...
This plugin has been updated to work against Unreal Engine 4.27.2, and it has been [https://twitter.com/tacolamp/status/1535116464679636992](confirmed to work in Unreal Engine 5 now as well). The [original Seurat UE4 plugin repository](https://github.com/googlevr/seurat-unreal-plugin) has been abandoned by Google and will not compile against 4.27.2 right off the bat, so this fork solves that problem and adds a couple more nifty features/changes:
